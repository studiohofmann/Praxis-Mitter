...
export const PRAXISGALERIE_QUERY = groq`*[_type == "praxisgalerie"] | order(reihenfolge) {bild}`
...
export const LEISTUNG_QUERY = groq`*[_type == "leistung"] | order(titel) {ueberschrift}`
